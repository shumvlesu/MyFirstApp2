...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button alertListSingle = findViewById(R.id.alertDialogListSingle);
        alertListSingle.setOnClickListener(clickAlertDialogListSingle);
    ...
    private View.OnClickListener clickAlertDialogList = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            // В билдере указываем заголовок окна. Можно указывать как ресурс, так и строку)
            builder.setTitle(R.string.exclamation)
                    //Вызов метода setItems() в строителе диалога позволяет выбрать пункт из списка. Список в данном
                    //случае — это массив строк. Одна строка — один пункт.
